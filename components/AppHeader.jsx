        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          ...
          >
            ...
            <div className="flex flex-col items-center text-center mt-4">
              ...
              {/* Guía de calificación — descarga siempre disponible */}
              <a
                href="/docs/guia-calificacion-matriz.pdf"
                download
                onClick={() => setMenuOpen(false)}
                className="w-full mb-3 bg-white/5 hover:bg-white/10 border border-white/10 text-white/80 font-bold py-3 px-6 rounded-2xl transition-all flex items-center justify-center gap-2"
              >
