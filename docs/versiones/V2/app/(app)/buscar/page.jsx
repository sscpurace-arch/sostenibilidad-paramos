    ...
    <div className="flex flex-col gap-4 pb-20">
      ...
      <div className="relative group">
        <input
          ...
          className="w-full p-5 pr-12 rounded-2xl border-2 border-gray-100 focus:border-[#03A64A] focus:outline-none shadow-sm transition-all text-lg"
          value={query}
        ...
        {loading ? (
          ...
          <div className="text-center py-10">
            ...
            <Link 
              ...
              className="text-[#03A64A] font-bold border border-[#03A64A] px-6 py-2 rounded-lg"
            >
              ¿Registrar nuevo?
            </Link>
          </div>
      ...
      <button 
        ...
        className="fixed bottom-24 right-6 w-14 h-14 bg-[#03A64A] text-white rounded-full shadow-xl flex items-center justify-center text-3xl font-light z-30"
      >
        +
      </button>
    </div>
