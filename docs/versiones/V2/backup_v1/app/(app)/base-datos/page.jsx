  ...
  return (
    <div className="flex flex-col gap-4 pb-20 max-w-full overflow-hidden">
      <header className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-1 text-[10px] font-bold text-[#2E7D32] bg-green-50 px-3 py-1 rounded-full animate-pulse">
          <span>DESLIZA</span>
          <span>→</span>
        </div>
      </header>
            ...
            <tr className="bg-gray-50 border-b border-gray-100">
              {[
                ...
                <th 
                  ...
                  className="p-4 text-[10px] uppercase font-black text-gray-400 cursor-pointer hover:text-[#2E7D32] transition-colors"
                >
