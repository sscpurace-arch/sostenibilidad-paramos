...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#E8F5E9] flex flex-col items-center justify-center p-6">
      <div className="bg-[#2E7D32] w-20 h-20 rounded-full flex items-center justify-center text-white text-4xl font-bold mb-4 shadow-lg">
        P
      </div>
      ...
      <div className="w-full max-w-sm flex flex-col gap-4">
        ...
        <input
          type="email"
          placeholder="Email"
          className="w-full p-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#2E7D32]"
          value={email}
        ...
        <button 
          onClick={handleLogin}
          disabled={loading}
          className="bg-[#2E7D32] text-white py-4 rounded-xl font-bold text-lg shadow-md mt-2 disabled:opacity-50"
        >
